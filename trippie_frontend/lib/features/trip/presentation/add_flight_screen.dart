...
class AddFlightScreen extends ConsumerStatefulWidget {
  const AddFlightScreen({super.key, required this.tripId});
...
class _AddFlightScreenState extends ConsumerState<AddFlightScreen> {
  ...
  bool get _canSubmit =>
      _departure != null && _arrival != null && !_submitting;
  ...
  Future<void> _submit() async {
    ...
    try {
      await ref.read(flightRepositoryProvider).createFlight(
        widget.tripId,
        {
